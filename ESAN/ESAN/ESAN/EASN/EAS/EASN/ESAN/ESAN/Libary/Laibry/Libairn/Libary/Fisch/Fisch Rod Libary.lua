...
if game:GetService("RunService"):IsServer() then
	require(game:GetService("ServerScriptService").server.legacyServices.WorldService)
else
	require(game:GetService("ReplicatedStorage"):WaitForChild("client").legacyControllers.WorldController)
end
local v2 = 0
for _, v3 in v1 do
	if typeof(v3) == "table" and not v3.Unregistered then
		v2 = v2 + 1
	end
end
v1.RegisteredNumberOfRods = v2
v1.UnRegistered = {
